import{t as e}from"./shaderStore-D-XQlhUT.js";import"./bakedVertexAnimation-k2eiXKMf.js";import"./clipPlaneVertex-gMyNlLVT.js";import"./instancesDeclaration-DWorEgDR.js";import"./helperFunctions-DquCMwzt.js";import"./bumpVertex-ZynzIDrr.js";import"./logDepthDeclaration-B8O1rFmO.js";import"./logDepthVertex-B7eOEYaq.js";import"./harmonicsFunctions-BSJ0aAy2.js";var t=`uvAttributeDeclaration`,n=`#ifdef UV{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var _=`shadowsVertex`,v=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var y=`vertexColorMixing`,b=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x=`pbrVertexShader`,S=`#include<pbrUboDeclaration>
...
}`;e.ShadersStoreWGSL[x]||(e.ShadersStoreWGSL[x]=S);var C={name:x,shader:S};export{C as pbrVertexShaderWGSL};