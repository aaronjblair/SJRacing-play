import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`motionBlurPixelShader`,n=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float motionStrength;uniform float motionScale;uniform vec2 screenSize;
#ifdef OBJECT_BASED
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as motionBlurPixelShader};