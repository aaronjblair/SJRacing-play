import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`bumpFragmentMainFunctions`,n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);var r=`samplerFragmentDeclaration`,i=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var a=`bumpFragmentFunctions`,o=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=o);var s=`bumpFragment`,c=`var uvOffset: vec2f= vec2f(0.0,0.0);
