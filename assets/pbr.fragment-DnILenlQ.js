import{t as e}from"./shaderStore-D-XQlhUT.js";import"./index-Bw1KhNWf.js";import"./imageProcessingFunctions-jreyjhRl.js";import"./harmonicsFunctions-PwxNwy_N.js";var t=`prePassDeclaration`,ee=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=ee);var n=`oitDeclaration`,te=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=te);var r=`decalFragmentDeclaration`,ne=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=ne);var i=`pbrFragmentDeclaration`,re=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=re);var a=`pbrFragmentExtraDeclaration`,ie=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=ie);var o=`lightFragmentDeclaration`,ae=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=ae);var s=`lightUboDeclaration`,c=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`samplerFragmentAlternateDeclaration`,oe=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=oe);var u=`pbrFragmentSamplersDeclaration`,se=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=se);var d=`subSurfaceScatteringFunctions`,ce=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=ce);var f=`importanceSampling`,le=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=le);var p=`pbrHelperFunctions`,ue=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=ue);var m=`shadowsFragmentFunctions`,de=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=fe);var g=`pbrDirectLightingSetupFunctions`,pe=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=pe);var _=`pbrDirectLightingFalloffFunctions`,me=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=me);var v=`pbrBRDFFunctions`,he=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=he);var y=`hdrFilteringFunctions`,ge=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
#endif
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=ge);var b=`pbrDirectLightingFunctions`,_e=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=_e);var x=`pbrIBLFunctions`,ve=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=ve);var S=`reflectionFunction`,ye=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ye);var C=`decalFragment`,be=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=be);var w=`pbrBlockAlbedoOpacity`,xe=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=xe);var T=`pbrBlockReflectivity`,Se=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Se);var E=`pbrBlockAmbientOcclusion`,Ce=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Ce);var D=`pbrBlockAlphaFresnel`,we=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=we);var O=`pbrBlockAnisotropic`,k=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var A=`pbrBlockReflection`,Te=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Te);var j=`pbrBlockSheen`,Ee=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=Ee);var M=`pbrBlockClearcoat`,De=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=De);var N=`pbrBlockIridescence`,Oe=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=Oe);var P=`pbrBlockSubSurface`,ke=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=ke);var F=`pbrBlockNormalGeometric`,Ae=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Ae);var I=`pbrBlockNormalFinal`,je=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=je);var L=`depthPrePass`,Me=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Me);var R=`pbrBlockLightmapInit`,Ne=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=Ne);var z=`pbrBlockGeometryInfo`,Pe=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Fe);var V=`pbrBlockReflectance`,Ie=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=Ie);var H=`pbrBlockDirectLighting`,Le=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=Le);var U=`lightFragment`,Re=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Re);var W=`pbrBlockFinalLitComponents`,ze=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=ze);var G=`pbrBlockFinalUnlitComponents`,Be=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=Be);var K=`pbrBlockFinalColorComposition`,q=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=q);var J=`pbrBlockImageProcessing`,Ve=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=Ve);var Y=`pbrBlockPrePass`,He=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=He);var X=`oitFragment`,Ue=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Ue);var Z=`pbrDebug`,We=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=We);var Q=`pbrPixelShader`,$=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var Ge={name:Q,shader:$};export{Ge as pbrPixelShader};